...
<head>
    ...
    ?> 
    <title>Soporte Técnico CDB - Bodega</title>
</head>
<body id="body-pd">
...
<h1 class="text-5xl font-extrabold dark:text-white" style="margin-top: 8vw;" ><span style="color: #2a3891;">Administración de </span> <span style="color: #4d227c;"> Bodega</span></h1>
<br>
