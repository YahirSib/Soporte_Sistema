                            ...
                            <div class="relative p-4 w-full max-w-4xl h-full md:h-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-6 space-y-6">
                                        <form id="editar" data_id="${trabajador.Id_trabajador}">
                                            <div class="mb-6">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <select style="font-size: 20px" id="tipo" name="tipo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  required>
                                                    ...
                                                    <option value="subjefe">Sub Jefe</option>
                ...
                if (trabajadores.status == false) {
                    ...
                    trabajadores.data.forEach(trabajador => {
                        ...
                        <tr class="bg-white dark:bg-gray-800">
                            ...
                            <td class="py-4 px-6">
                                <a  data_id="${trabajador.Id_trabajador}" style="font-size: 20px" class="editar font-medium text-green-600 underline dark:text-green-500 hover:no-underline cursor-pointer" type="button" data-modal-toggle="question"><i class='bx bx-edit'></i></a>
                                <a  data_id="${trabajador.Id_trabajador}" style="font-size: 20px;  margin-left: 10px" class="eliminar font-medium text-red-600 underline dark:text-red-500 hover:no-underline cursor-pointer" type="button" data-modal-toggle="question"><i class='bx bx-trash'></i></a>
                                <a  data_id="${trabajador.Id_trabajador}" style="font-size: 20px;  margin-left: 10px" class="contra font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline cursor-pointer" type="button" data-modal-toggle="question"><i class='bx bx-reset'></i></a>
                            </td>
                        </tr>        
                        `
                    });
