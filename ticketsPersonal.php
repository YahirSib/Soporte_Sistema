    ...
    <form id="frmBuscarEspera">
        <div class="grid md:grid-cols-2 md:gap-6"> 
            ...
            <div class="mb-6">
                ...
                <a data_id ="<?php echo $id; ?>" style="font-size: 20px"  class="agregar py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"><i class='bx bx-plus'></i></a>
            </div>
        </div>
    </form>
    <!--CURD-->
...
<!--Cada <div/> respresenta un artículo-->
    ...
    <form id="frmBuscarAceptados">
        <div class="grid md:grid-cols-2 md:gap-6"> 
            <div class="mb-6">
                <div class="flex">
                    <span  style="font-size: 20px" class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 rounded-l-md border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">Tickets Aceptados:</span>
                    <input  style="font-size: 20px" type="text" id="txtBuscarAceptados" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Id del ticket...">
                </div>
            </div>
            <div class="mb-6">
                <button  style="font-size: 20px" type="submit" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><i class='bx bx-search' style='color:#ffffff' ></i></button>
        ...
        <!--CURD-->
<div id="aceptados" class="grid md:grid-cols-3 md:gap-6">
<!--Cada <div/> respresenta un artículo-->
    ...
    <form id="frmBuscarCancelados">
        <div class="grid md:grid-cols-2 md:gap-6"> 
            <div class="mb-6">
                <div class="flex">
                    <span  style="font-size: 20px" class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 rounded-l-md border border-r-0 border-gray-300 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">Tickets Cancelados:</span>
                    <input  style="font-size: 20px" type="text" id="txtBuscarCancelados" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Id del ticket...">
                </div>
            </div>
            <div class="mb-6">
                <button  style="font-size: 20px" type="submit" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"><i class='bx bx-search' style='color:#ffffff' ></i></button>
        ...
        <!--CURD-->
<div id="cancelados" class="grid md:grid-cols-3 md:gap-6">
<!--Cada <div/> respresenta un artículo-->
...
<script src="controlador/ticketsPersonal.js"></script>
