...
<head>
    ...
    ?> 
    <title>Soporte Técnico CDB - Trabajadores</title>
</head>
<body id="body-pd">

<?php
$pag = "Trabajador"; //Se inicializa la var $pag para determinar en que sección del menu se encuentra para dar estilo de enfoque
include('recursos/menu.php');
?>

<!-- Contenido del sitio web-->
<h1 class="text-5xl font-extrabold dark:text-white" style="margin-top: 8vw;" ><span style="color: #2a3891;">Administración de </span> <span style="color: #4d227c;"> Trabajadores</span></h1>
<br>
...
<div class="mb-6">
<button  style="font-size: 20px" type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Buscar trabajador <i class='bx bx-search' style='color:#ffffff' ></i></button>
</div>
</div>
